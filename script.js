...
document.addEventListener('DOMContentLoaded', function() {
    ...
    backgroundMusic.volume = 0.7; // Громкость 50%
...
const mediaData = [
    {
        ...
        comment: 'Твои глаза – две искры света, В них отражается мечта. Как будто теплый луч рассвета, Как будто светлая весна. 🌸'
    },
	{
        type: 'image',
        src: 'images/photo2.jpg',
        comment: 'Улыбка – нежность, что так греет, Как теплый ветер в летний день. И сердце трепетно немеет, Слова сплетаются в сирень. 🌸'
    },
	{
        type: 'image',
        src: 'images/photo3.jpg',
        comment: 'Ты — вдохновение, ты — чудо, Ты — капля счастья в каждом дне. И пусть прекрасным этим утромСтихи дарю тебе я нежные. 🌸'
    },
];
...
function playBackgroundMusic() {
    // Проверяем, была ли уже взаимодействие пользователя
    const playPromise = backgroundMusic.play();
    
    // Если браузер требует взаимодействия пользователя для воспроизведения
    if (playPromise !== undefined) {
        playPromise.catch(error => {
            console.log('Автовоспроизведение заблокировано. Требуется взаимодействие пользователя.');
            
            // Добавляем обработчик для запуска музыки при первом клике
